...
# # Update Job model to add company relationship
# # Modify the existing Job class:
# class Job(Base):
#     __tablename__ = "jobs"
    
#     id = Column(Integer, primary_key=True, index=True)
#     company_id = Column(Integer, ForeignKey("companies.id"), nullable=True)  # Add this
#     title = Column(String, nullable=False)
#     company = Column(String, nullable=False)  # Keep for backward compatibility
#     location = Column(String)
#     description = Column(Text, nullable=False)
#     requirements = Column(Text)
#     salary_range = Column(String)
...
#     title = Column(String, nullable=False)
#     company = Column(String, nullable=False)  # Company name as string
#     location = Column(String)
#     description = Column(Text, nullable=False)
#     requirements = Column(Text)
#     salary_range = Column(String)
